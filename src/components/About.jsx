...
const About = () => {
  return (
    <>
      ...
      >
        More than 7+ years experience with advanced. Equipped with a divers and promsing <br/>skill-set:
        JavaScript, TypeScript, React, Vue.js, Next.js, NodeJS, Django, etc.<br/>
